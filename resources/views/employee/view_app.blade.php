                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="date" value="{{$application->status}}"
                                               class="form-control form-control-alternative" placeholder="days"
                                               disabled>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="date" value="{{$application->allowance}}"
                                                   class="form-control form-control-alternative" placeholder="days"
                                                   disabled>
                                        </div>
                                    </div>
                                ...
                                <div class="pl-lg-4">
                                    <div class="form-group">
                                        ...
                                        <textarea rows="4" name="reject_reason" class="form-control form-control-alternative"
                                                  placeholder="{{$application->reject_reason}}" disabled></textarea>
                                    </div>
                                </div>
                                    @endif
