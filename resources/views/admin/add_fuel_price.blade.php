                ...
                <div class="card bg-secondary shadow">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">Add Fuel Price</h3>
                            </div>
                            <div class="col-4 text-right">
                                <a href="{{ route('view_fuel_prices') }}" class="btn btn-sm btn-primary">View Branches</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('save_fuel_price') }}">
                            {{ csrf_field() }}
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <select type="text" name="type" class="form-control form-control-alternative" placeholder="Name" required>
