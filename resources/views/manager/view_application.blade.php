                ...
                <div class="card bg-secondary shadow">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">View Application</h3>
                            </div>
                    ...
                    @endif
                    <div class="card-body">
                        <form method="POST" action="{{ route('update_emp_application') }}">
                            {{ csrf_field() }}
                            ...
                            <div class="pl-lg-4">
                                ...
                                @if($application->is_calculatable=='true')
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label class="form-control-label" for="input-first-name">Allowance</label>
                                        <input type="number"
                                               class="form-control form-control-alternative" value="{{$application->allowance}}" placeholder="allowance" disabled>
                                    </div>
                                </div>
                                @else
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="allowance"
                                                   class="form-control form-control-alternative" placeholder="allowance">
                                        </div>
                                    </div>
                                    @endif
                                <div class="pl-lg-4">
